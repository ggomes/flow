...
class MacroTrafficLightGridEnv(Env):
...
class MacroTrafficLightGridPOEnv(MacroTrafficLightGridEnv):
    """Environment used to train traffic lights.
...
class MacroTrafficLightGridTestEnv(MacroTrafficLightGridEnv):
    """
